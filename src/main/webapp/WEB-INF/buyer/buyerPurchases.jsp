        ...
        <div class="main-body">
            <div class="row gutters-sm">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3"><h4><c:if
                                    ...
                                    <a href="editProfileForm" class="btn mt-3" style="outline-color: #EB984E">Изменить</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body">
                            <c:if test="${empty historyListMap}">
                                <div class="d-flex justify-content-center">
                                    <div class="d-flex h-100">
                                        <div class="my-auto mx-auto d-flex flex-column">
                                            ...
                                            <h2 class="text-center mb-3">История покупок пуста :(</h2>
                                            <span class="text-muted mb-2" style="font-size: 18px">Купите что-нибудь, чтобы обогатить мой магазин :)</span>
                                            <a href="listProducts" class="btn w-50 mx-auto mt-2"
                                               style="margin-bottom: 5rem; background-color: #EB984E">Что-нибудь купить</a>
                                        </div>
                                    </div>
                                </div>
                            </c:if>

                            <table class="table table-striped table-hover mx-auto <c:if test="${empty historyListMap}">d-none</c:if>">
                                ...
                                <c:forEach var="entry" items="${historyListMap}" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${entry.key.status == 'reserved'}">
                                                <a class="btn" style="background-color: #EB984E" href="#">Оплатить</a>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
